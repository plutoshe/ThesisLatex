...
\documentclass[UTF8, openany, colorlinks]{pkuthss}
% openany, 
% \documentclass[, colorlinks]{pkuthss}
...
\pkuthssinfo{
	...
	ctitle = {基于人脸识别技术的\\轻量级社交平台}, etitle = {Light Social Application based on Face Recognition},
	cauthor = {佘俊峰},
	eauthor = {Pluto She},
	studentid = {1100012769},
	date = {二〇一五年五月},
	school = {信息科学技术学院},
	cmajor = {计算机}, emajor = {Computer Science},
	direction = {移动互联网},
	cmentor = {边凯归}, ementor = {Prof.\ Kaigui Bian},
	ckeywords = {人脸识别，图片社交应用，移动设备，匹配算法}, ekeywords = {Face recognition, photo sharing application, mobile application, matching algorithm}
}
...
\begin{document}
	...
	% % 各附录。
	% \appendix
	% \printbibliography[title = {文献},heading = bibintoc, sorting = ecnty]
	% \include{chap/encl1}
